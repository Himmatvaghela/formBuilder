...
@Component({
  selector: 'app-nf-single-select-property',
  templateUrl: './nf-single-select-property.component.html',
  styleUrls: ['./nf-single-select-property.component.css'],
})
export class NfSingleSelectPropertyComponent implements OnInit {
