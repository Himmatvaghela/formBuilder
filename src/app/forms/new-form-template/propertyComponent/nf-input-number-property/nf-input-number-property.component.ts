...
@Component({
  selector: 'app-nf-input-number-property',
  templateUrl: './nf-input-number-property.component.html',
  styleUrls: ['./nf-input-number-property.component.css'],
})
export class NfInputNumberPropertyComponent implements OnInit {
