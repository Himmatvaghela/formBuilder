...
@Component({
  selector: 'app-nf-multi-select-property',
  templateUrl: './nf-multi-select-property.component.html',
  styleUrls: ['./nf-multi-select-property.component.css'],
})
export class NfMultiSelectPropertyComponent implements OnInit {
